 ...
 */
class PatchedJetty9UpgradeHttpRequest extends HttpServletRequestWrapper {
	...
	PatchedJetty9UpgradeHttpRequest(UpgradeRequest upgradeRequest) {
	...
	private static HttpServletRequest extractHttpRequest(UpgradeRequest upgradeRequest) {
		if (upgradeRequest instanceof ServletUpgradeRequest == false) {
			throw new IllegalArgumentException(PatchedJetty9UpgradeHttpRequest.class.getName() +
